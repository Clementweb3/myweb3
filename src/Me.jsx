  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Camera001" position={[0, 1.02, 5.41]} rotation={[Math.PI / 2, 0, 0]}>
          <PerspectiveCamera name="Camera001_Orientation" makeDefault={true} far={1000} near={0.1} fov={22.9} rotation={[-Math.PI / 2, 0, 0]} />
        </group>
      </group>
    </group>
  )
